...
const Projects = () => {
    ...
    return (
        <div className='md:flex h-full bg-sec-bg'>
            ...
            <div className='md:w-10/12  overflow-scroll projects-board text-text' >
                        ...
                        <div className='flex relative   '>
                            ...
                            <div className='m-2 md:flex w-full h-full'>
                                <div className='w-full md:w-8/12 text-left py-16 md:py-2 px-4 md:px-16  h-full border-r border-border-bg '>
                                    <h2 className='text-[16px] md:text-[25px] font-semibold '>{detailsProject.title}</h2>
                                    ...
                                    >
                                        {
                                            detailsProject.images.map(img => <SwiperSlide> <img src={img} alt="" className='my-2 h-[200px] md:h-[400px] w-full rounded-lg' /></SwiperSlide>)
                                        }
                                    ...
                                    <div className='md:flex items-start my-10'>
                                        ...
                                        <p className='px-2'>{detailsProject.longDes}</p>
                                    </div>
                                    <div className='md:flex items-start my-10'>
                                        ...
                                        <div className='px-2'>
                                            {
                                                ...
                                                detailsProject.technology.backend.map(tag => <TagButton text={tag} key={tag}></TagButton>)
                                            }
                                            {
                                                detailsProject.technology.frontEnd.map(tag => <TagButton text={tag} key={tag}></TagButton>)
                                            }
                                        </div>
                                    </div>
                                </div >
                                <div className='w-full md:w-4/12 text-left px-4'>
                                    <div className='flex justify-between'>
                                        <SecondButton path={detailsProject.livecode} text='Live Code'></SecondButton>
                                    ...
                                    <div className=' my-10'>
                                        ...
                                        <ul className='px-2'>
                                            {/* {
                                                detailsProject.challanges.map(challange => <li className='flex items-start px-0 md:px-10 my-4'><img src={staroutline} alt="" /> <span className='px-2 text-lg'>{challange.text} </span></li>)
                                            } */}
                                        </ul>
                                    </div>
                                    <div className=' my-10'>
                                        ...
                                        <ul className='px-2'>
                                            {/* {
                                                detailsProject.features.map(feature => <li className='flex items-start px-0 md:px-10 my-4'><img src={starfill} alt="" /> <span className='px-2 text-lg'>{feature.text} </span></li>)
                                            } */}
                                        </ul>
                                    </div>
                                    <div className=' my-10'>
