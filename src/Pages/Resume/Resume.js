...
const Resume = () => {
    ...
    return (
        <div className='overflow-scroll resume'>
            <div className='resume-head border-b border-[#334155] '>
                <div className='py-6 resume-content'>
                    ...
                    <div className='flex justify-center my-4'>
                        <a href="_#" className='flex items-center bg-[#F6F3FF] text-[#000000] px-4 py-2 rounded-full mx-2 text-[12px]'><img src={linkedin} alt="" /> <span className='mx-2'>mkhadhd</span> </a>
                        <a href="_#" className='flex items-center bg-[#F6F3FF] text-[#000000] px-4 py-2 rounded-full mx-2 text-[12px]'><img src={web} alt="" /> <span className='mx-2'>mkhadhd</span> </a>
                        <a href="_#" className='flex items-center bg-[#F6F3FF] text-[#000000] px-4 py-2 rounded-full mx-2 text-[12px]'><img src={github} alt="" /> <span className='mx-2'>hithub</span> </a>
                    </div>
                </div>
            </div>
            <dir className='resume-body text-left text-[14px] mx-2 md:mx-10'>
                ...
                <div className='md:flex justify-around border-b border-[#334155] py-6 my-6' >
                    ...
                    <div className='md:w-10/12  '>
                        <div className='flex justify-between'><h2><strong>Dhaka University</strong> -English(Honurs) </h2><div className='flex items-center'><img src={calender} alt="" /> <span className='mx-2'>Oct 2018 - present</span></div></div>
                    </div>
                ...
                <div className='md:flex justify-around border-b border-[#334155] py-6 my-6' >
                    ...
                    <div className='md:w-10/12  '>
                        <div className='my-2'>
                            <div className='flex justify-between'><h2><strong>I texh Art</strong> — Front-End Developer (self-employed) </h2><div className='flex items-center'><img src={calender} alt="" /> <span className='mx-2'>Oct 2018 - present</span></div></div>
                            <div>
